...
Command: npx gltfjsx@6.5.3 public/models/alge.glb 
*/
...
export function Alge(props) {
  const { nodes, materials } = useGLTF('/models/alge.glb')
...
useGLTF.preload('/models/alge.glb')
